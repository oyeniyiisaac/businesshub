    ...
    <>
      <nav className='bg-[#ffffff] shadow-sm py-3 px-4 flex justify-between items-center'>
        ...
        <ul className='flex gap-6'>
          <li className='hover:text-[#006a40]/80 text-[#404b43] text-lg transition-colors cursor-pointer'>Features</li>
          <li className='hover:text-[#006a40]/80 text-[#404b43] text-lg transition-colors cursor-pointer'>Benefits</li>
          <li className='hover:text-[#006a40]/80 text-[#404b43] text-lg transition-colors cursor-pointer'>Pricing</li>
        </ul>
